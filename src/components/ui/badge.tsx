  ...
  "inline-flex w-fit shrink-0 items-center justify-center rounded-full whitespace-nowrap py-0.5 font-medium capitalize tabular-nums select-none transition-all [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg]:block",
  {
    variants: {
      variant: {
        ...
        trial: "bg-linear-[135deg,rgb(0,112,243),rgb(248,28,229)] text-white",
        turbo: "bg-linear-[135deg,rgb(255,30,86),rgb(0,150,255)] text-white",
        ipf: "bg-linear-[135deg,rgb(9,30,95),rgb(209,0,22)] text-white",
        ipl: "bg-linear-[135deg,rgb(5,104,57),rgb(0,0,0)] text-white",
        wrpf: "bg-linear-[135deg,rgb(229,47,17),rgb(0,0,0)] text-white",
