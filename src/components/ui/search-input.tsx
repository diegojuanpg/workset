...
export interface SearchInputProps extends Omit<InputProps, "suffix" | "value" | "onChange"> {
  ...
  cmdk?: boolean
  /** Single-key shortcut badge shown while empty (e.g. "F"). */
  shortcut?: string
...
export const SearchInput = React.forwardRef<HTMLInputElement, SearchInputProps>(
  ({ value, defaultValue, onChange, onValueChange, loading = false, showShortcut = false, cmdk = false, shortcut, prefix, disabled, onKeyDown, ...props }, ref) => {
    ...
    // Esc (clears) appears whenever there's text; the shortcut badge when empty.
    const suffix =
      !disabled && (isDirty || displayCmdk || shortcut) ? (
